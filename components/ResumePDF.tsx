...
const ResumePDF = () => {
  ...
  useEffect(() => {
    const generatePDF = async () => {
      // 确保 PDF 实例存在
      if (pdfRef.current) {
        const blob = await pdf(pdfRef.current).toBlob()
  ...
  return (
    <Document>
      <Page size="A4" style={styles.page} ref={pdfRef}>
        <View style={styles.section}>
          <View style={styles.line}></View>
          <Text style={styles.heading}>About</Text>
          <Text style={styles.text}>
            My name is Orion Chen. I am a software engineer with a passion for web development. I
            have experience in both frontend and backend development, and I am always eager to learn
            new technologies. I am currently pursuing a master's degree in software engineering at
            the University of St. Andrews. I am looking for opportunities to work on exciting
            projects and contribute to the tech community.
          </Text>
          <Text style={styles.text}>
            In my free time, I enjoy reading, hiking, and playing video games. I am also a big fan
            of open-source software and enjoy contributing to open-source projects. I am always
